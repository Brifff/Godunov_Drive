...
//  Godunov drive
//
//  Created by Годунов Антон Иванович on 16/1/2023.
//
...
class GameViewController: UIViewController {
    ...
    func gameEnd(message: String){
        ...
        result.append(resultData(playerName: "me", resultGame: message, timeGame: String(timeLeft)))
    }
